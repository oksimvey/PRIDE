...
public class WeaponPresets {
    ...
    public static final Function<Item, CapabilityItem.Builder> PRIDE_COLOSSALSWORD = (item) -> WeaponCapability.builder().category(WeaponCategoriesEnum.PRIDE_COLOSSALSWORD)
            ...
            .hitSound(EpicFightSounds.BLADE_HIT.get())
            .hitParticle(EpicFightParticles.HIT_BLADE.get())
            .newStyleCombo(Styles.ONE_HAND, AnimationsRegister.SWORD_ONEHAND_AUTO2, AnimationsRegister.SWORD_ONEHAND_AUTO3, AnimationsRegister.SWORD_ONEHAND_AUTO4, DualAxesAnimations.AXE_AUTO_3, Animations.BIPED_MOB_ONEHAND1, Animations.SWORD_AIR_SLASH)
            ...
            .newStyleCombo(PrideStyles.DUAL_WIELD, AnimationsRegister.DUAL_GREATSWORD_AUTO1, AnimationsRegister.DUAL_GREATSWORD_AUTO2, AnimationsRegister.DUAL_GREATSWORD_AUTO3, AnimationsRegister.DUAL_GREATSWORD_AUTO4, AnimationsRegister.DUAL_GREATSWORD_DASH, AnimationsRegister.DUAL_GREATSWORD_AIRSLASH)
            .newStyleCombo(Styles.MOUNT, Animations.SWORD_MOUNT_ATTACK)
