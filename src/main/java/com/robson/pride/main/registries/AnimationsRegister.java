...
public class AnimationsRegister {
        ...
        public static StaticAnimation MIKIRI_TWO_HAND;
        public static StaticAnimation MIKIRI_DUAL_WIELD;
        public static StaticAnimation MIKIRI_MAIN_HAND;
        ...
        HumanoidArmature biped = Armatures.BIPED;
            ...
            MIKIRI_TWO_HAND = (new LongHitAnimation(0.25F, "pride:biped/skill/mikiri_two_hand",biped));
            MIKIRI_DUAL_WIELD = (new LongHitAnimation(0.25F, "pride:biped/skill/mikiri_dual_wield",biped));
            MIKIRI_MAIN_HAND = (new LongHitAnimation(0.25F, "pride:biped/skill/mikiri_main_hand",biped));
