...
public class HunterRenderer extends HumanoidMobRenderer<Hunter, HumanoidModel<Hunter>> {
    ...
    public ResourceLocation getTextureLocation(Hunter entity) {
        return new ResourceLocation("pride:textures/entities/hunter/hunter1.png");
    }
}
