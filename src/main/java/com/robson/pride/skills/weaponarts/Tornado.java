...
public interface Tornado {
    ...
    WeaponSkillData DATA = new WeaponSkillData("Tornado", ServerDataManager.TORNADO, "pride:models/item/scroll_wind", SkillCore.WeaponArtTier.RARE, ServerDataManager.WIND, 25, 5, "pierce_two_hand") {
