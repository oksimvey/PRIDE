...
public abstract class MobData {
    ...
    protected MobData(ResourceLocation texture, ActionsBuilder combatActions, Map<EquipmentSlot, ItemStack> equipment, boolean humanoid, Armature armature,Map<StunType, AnimationManager.AnimationAccessor<? extends StaticAnimation>> stunMotions) {
