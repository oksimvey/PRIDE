...
public interface NatureElement  {
    ...
    ElementData DATA = new ElementData(new CompoundTag(), "Nature", (byte) 8, ParticleTypes.COMPOSTER, ChatFormatting.DARK_GREEN, SoundRegistry.POISON_SPLASH_BEGIN.get(),
