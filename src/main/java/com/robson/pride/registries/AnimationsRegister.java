...
public class AnimationsRegister {
    ...
    public static StaticAnimation GS_AUTO1;
    public static StaticAnimation GS_AUTO2;
    public static StaticAnimation GS_AUTO3;
    ...
    private static void build() {
        ...
        GS_AUTO1 = (new BasicAttackAnimation(0.1F, 0.3F, 0.4F, 0.5F, InteractionHand.MAIN_HAND, ColliderPreset.GREATSWORD, biped.toolR, "biped/combat/greatsword/greatsword_twohand_auto_1", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.05F);
        GS_AUTO2 = (new BasicAttackAnimation(0.1F, 0.3F, 0.4F, 0.5F, InteractionHand.MAIN_HAND, ColliderPreset.GREATSWORD, biped.toolR, "biped/combat/greatsword/greatsword_twohand_auto_2", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.05F);
        GS_AUTO3 = (new BasicAttackAnimation(0.1F, 0.4F, 0.5F, 0.6F, InteractionHand.MAIN_HAND, ColliderPreset.GREATSWORD, biped.toolR, "biped/combat/greatsword/greatsword_twohand_auto_3", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.05F);
        HOLD_GREATSWORD = (new StaticAnimation(true, "biped/combat/greatsword/hold_greatsword", biped));
